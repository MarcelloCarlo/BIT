<?php 
	...
	$CensusOfficerEditCitizenSQL = 'UPDATE bitdb_r_citizen
	...
	$CensusOfficerEditCitizenQuery = mysqli_query($bitMysqli,$CensusOfficerEditCitizenSQL) or die (mysqli_error($bitMysqli));
