                             ...
                             <tbody>
                              ...
                              while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['BusinessLoc'];?></td>
                                    <td><?php echo $row['Manager'];?></td>
                                    <td><?php echo $row['Mgr_Address'];?></td>
                                    <td><?php echo $row['Date_Issued'];?></td>
                                    <td><?php 
                                        if($row['BusinessStatus'] == 1)
                                        {
                                           echo $row['BusinessStatus'] = "Active";
                                        }
                                        else
                                        {
                                            echo $row['$BusinessStatus'] = "Inactive";
                                        }
                                        ?></td>
