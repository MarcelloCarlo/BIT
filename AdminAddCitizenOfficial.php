<?php
	...
	$CitizenOffAddSQL = 'INSERT INTO bitdb_r_citizen(Salutation,First_Name,Middle_Name,Last_Name,Name_Ext,Citizen_Email,Height,Weight,Birthdate,Birth_Place,Nationality,Res_Status,Civil_Status,Occupation,Gender,Blood_Type,House_No,Street,Zone,Date_Rec) VALUES ("'.$Salutation.'","'.$First_Name.'","'.$Middle_Name.'","'.$Last_Name.'","'.$Name_Ext.'","'.$Email.'","'.$Height.'","'.$Weight.'","'.$Birthdate.'","'.$Birth_Place.'","'.$Nationality.'",'.$Res_Status.',"'.$Civil_Status.'","'.$Occupation.'","'.$Gender.'","'.$Blood_Type.'","'.$House_No.'","'.$Street.'","'.$Zone.'",CURRENT_DATE)';
	...
	$BarangayOffAddSQL = 'INSERT INTO bitdb_r_barangayofficial(CitizenID,PosID,StartTerm,EndTerm,ActUser) VALUES('.$CitizenCount.','.$PosID.',"'.$StartTerm.'","'.$EndTerm.'",0)';
