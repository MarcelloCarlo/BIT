        ...
        <div class="modal fade" id="addPosModal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="PositionAdd" action="Level0_AddPosition.php" method="POST">
        ...
        <div class="modal fade" id="editPosModal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="PositionEdit" action="Level0_EditPosition.php" method="POST">
                        <div class="modal-body">
                            <div class="row clearfix margin-0">
